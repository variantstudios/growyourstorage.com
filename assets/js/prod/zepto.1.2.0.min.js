	...
	var e = (function() {
		...
		function z(t) {
			var e = !!t && 'length' in t && t.length,
				n = r.type(t);
			return (
				'function' != n && !k(t) && ('array' == n || 0 === e || ('number' == typeof e && e > 0 && e - 1 in t))
			);
		}
		function q(t) {
			...
			try {
				return t
					? 'true' == t ||
						('false' == t
							? !1
							: 'null' == t ? null : +t + '' == t ? +t : /^[\[\{]/.test(t) ? r.parseJSON(t) : t)
					: t;
			} catch (e) {
				return t;
			}
			...
			[ 'width', 'height' ].forEach(function(t) {
				...
				r.fn[t] = function(i) {
					var o,
						s = this[0];
					return i === e
						? k(s) ? s['inner' + n] : M(s) ? s.documentElement['scroll' + n] : (o = this.offset()) && o[t]
						: this.each(function(e) {
